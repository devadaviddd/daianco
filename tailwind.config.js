  ...
  theme: {
    extend: {
      ...
      fontFamily: {
        ...
        andantedisplay_demi_bold_italic: ["var(--font-andanteDisplay-demi-bold-italic)"],
        andantedisplay_extralight: ["var(--font-andanteDisplay-extralight)"],
        andantedisplay_extralight_italic: ["var(--font-andanteDisplay-extralight-italic)"],
        andantedisplay_light: ["var(--font-andanteDisplay-light)"],
        andantedisplay_light_italic: ["var(--font-andanteDisplay-light-italic)"],
        andantedisplay_medium: ["var(--font-andanteDisplay-medium)"],
        andantedisplay_medium_italic: ["var(--font-andanteDisplay-medium-italic)"],
        andantedisplay_regular: ["var(--font-andanteDisplay-regular)"],
        andantedisplay_regular_italic: ["var(--font-andanteDisplay-regular-italic)"],
        andantedtext_bold: ["var(--font-andantedText-bold)"],
        andantedtext_bold_italic: ["var(--font-andantedText-bold-italic)"],
        andantedtext_demi_bold: ["var(--font-andantedText-demi-bold)"],
        andantedtext_demi_bold_italic: ["var(--font-andantedText-demi-bold-italic)"],
        andantedtext_extralight: ["var(--font-andantedText-extralight)"],
        andantedtext_extralight_italic: ["var(--font-andantedText-extralight-italic)"],
        andantedtext_light: ["var(--font-andantedText-light)"],
        andantedtext_light_italic: ["var(--font-andantedText-light-italic)"],
        andantedtext_medium: ["var(--font-andantedText-medium)"],
        andantedtext_medium_italic: ["var(--font-andantedText-medium-italic)"],
        andantedtext_regular: ["var(--font-andantedText-regular)"],
        andantedtext_regular_italic: ["var(--font-andantedText-regular-italic)"],
      },
    },
  },
  plugins: [],
